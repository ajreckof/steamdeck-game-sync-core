...
const name_property : StringName = &"start_dir"
...
var steam_shortcut : SteamShortcut :
	set(value) :
		...
		if is_node_ready() :
			line_edit.text = str(steam_shortcut.start_dir)
...
func _on_button_pressed() -> void:
	var current_dir = steam_shortcut.start_dir
...
func _on_file_dialog_dir_selected(dir: String) -> void:
	steam_shortcut.start_dir = dir
	line_edit.text = dir


func _on_line_edit_text_submitted(new_text: String) -> void:
	steam_shortcut.start_dir = new_text


func _on_line_edit_focus_exited() -> void:
	steam_shortcut.start_dir = line_edit.text
